...
/**
 * @covers \Eloquent\Lockbox\Stream\Filter\RawEncryptStreamFilter
 * @covers \Eloquent\Lockbox\Stream\Filter\AbstractCipherStreamFilter
 */
class RawEncryptStreamFilterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFilter()
    {
        ...
        stream_filter_append($stream, 'lockbox.encrypt-raw', STREAM_FILTER_WRITE, $this->parameters);
